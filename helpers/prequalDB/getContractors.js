...
export const getContractors = async (canUpdate, filters) => {
    try {
      ...
      ${canUpdate
            ? ' phone_number,'
            : " case when healthSafety_isSatisfactory = 1 and wsib_isSatisfactory = 1 and insurance_isSatisfactory = 1 then phone_number else '' end as phone_number,"} email_name,
      ${canUpdate
            ? ' email_address,'
